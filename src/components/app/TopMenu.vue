	...
	<div id="top-menu" class="app-top-menu" data-bs-theme="dark">
		<div class="menu">
			...
			<div class="menu-item menu-control menu-control-start">
				<a href="javascript:;" class="menu-link" v-on:click="handleMenuButtonAction($event, 'prev')"><i
						class="fa fa-angle-left"></i></a>
			</div>
			<div class="menu-item menu-control menu-control-end">
				<a href="javascript:;" class="menu-link" v-on:click="handleMenuButtonAction($event, 'next')"><i
