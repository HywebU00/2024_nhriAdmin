...
import { useAppVariableStore, generateVariables } from '@/pinia/app-variable';
				...
				<div class="col-md-4 d-flex">
					<div class="form-check form-switch ms-auto mb-0">
						<input type="checkbox" class="form-check-input" id="appGradientEnabled"
							v-on:change="toggleGradientEnabled()" v-model="appOption.appGradientEnabled" true-value="true"
							false-value="" />
