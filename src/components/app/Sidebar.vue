...
<template>
			...
			<div class="menu">
				...
				<div class="menu-item d-flex">
					<a href="javascript:;"
						...
						v-on:click="toggleAppSidebarMinified($event)"><i class="fa fa-angle-double-left"></i></a>
				</div>
				<!-- END minify-button -->
			</div>
		</perfect-scrollbar>
	...
	<div class="app-sidebar-mobile-backdrop"><a href="#" v-on:click="appSidebarMobileToggled" class="stretched-link"></a>
	</div>
</template>