...
// const newItem2 = {
// 	url: '/email', icon: 'fa fa-hdd', title: 'Email222', badge: '10',
// 	children: [
        ...
        if (appElm && appElm.classList.contains('app-sidebar-minified')) {
          ...
          if (targetMenuHtml) {
            ...
            if (!document.querySelector('#app-sidebar-float-submenu')) {
              ...
              html.innerHTML =
                '' + '	<div class="app-sidebar-float-submenu-arrow" id="app-sidebar-float-submenu-arrow"></div>' + '	<div class="app-sidebar-float-submenu-line" id="app-sidebar-float-submenu-line"></div>' + '	<div class="app-sidebar-float-submenu ' + overflowClass + '">' + targetMenuHtml + '</div>';
...
<template>
  <div
    id="sidebar"
    class="app-sidebar"
    :data-bs-theme="appOption.appSidebarLight ? 'light' : 'dark'"
    v-bind:class="{
      'app-sidebar-grid': appOption.appSidebarGrid,
      'app-sidebar-transparent': appOption.appSidebarTransparent,
    }"
  >
    <div class="app-sidebar-content" v-bind:class="{ 'h-100': appOption.appSidebarFixed }">
      <div class="menu">
          ...
          <a href="javascript:;" class="menu-profile-link" v-on:click="appSidebarProfileToggle($event)">
            ...
            <div class="menu-profile-info">
              <div class="d-flex align-items-center">
                <div class="flex-grow-1 d-flex align-items-center">Sean Ngu</div>
