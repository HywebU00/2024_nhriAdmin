<template>
  <v-card>
    <v-card-title>
      <h4 class="mt-1 mb-3 ml-3">計畫經費檢視</h4>
    </v-card-title>
    <v-card-text>
      <v-table density="compact">
        <thead>
          <tr>
            ...
            <th class="text-left bg-thead thead" width="15%">主計畫代號</th>
            <th class="text-left bg-thead thead" width="20%">科目別</th>
            <th class="text-left bg-thead thead" width="20%">項目</th>
            <th class="text-left bg-thead thead" width="10%">原提報金額</th>
            <th class="text-left bg-thead thead" width="10%">期初核定金額</th>
          </tr>
        </thead>
        <tbody>
  ...
  <div v-if="dialog1">
    <v-dialog width="60%" v-model="dialog1" scrollable>
      <planExpenseDetailComp :selectItem="selectItem" :selectDetail="targetItem" @childDialog="parentDialog"> </planExpenseDetailComp>
    </v-dialog>
  </div>
</template>
