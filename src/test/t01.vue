<template>
  ...
  <panel>
    ...
    <panel-body>
      ...
      <div class="row gx-3" id="icon">
        !!!{{ testArray2 }}
        <div class="col-lg-3 col-md-4 col-6 pb-3 d-flex align-items-center fw-bold"><Icon class="iconify me-2 display-6" icon="solar:4k-bold-duotone" /><span>solar:4k-bold-duotone</span></div>
      </div>
      <VTree ref="basicTreeRef" :data="testArray2" :nodeClassName="(node) => `generated-class-${node.id}`" v-model="selectValue" selectable checkable />
      ...
      <v-chip class="ma-2" closable> Closable </v-chip>
